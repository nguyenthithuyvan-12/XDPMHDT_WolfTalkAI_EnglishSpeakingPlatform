    ...
    <div className="transactions-page">
      ...
      <div className="transactions-page__stats">
        <div className="transactions-page__stat-card transactions-page__stat-card--revenue glass-card">
          ...
          <div className="transactions-page__stat-content">
            ...
            <div className="transactions-page__stat-value">{formatCurrency(stats.totalRevenue, 'VND')}</div>
          </div>
        </div>
        ...
        <div className="transactions-page__stat-card transactions-page__stat-card--approved glass-card">
          ...
          <div className="transactions-page__stat-content">
            ...
            <div className="transactions-page__stat-value">{stats.approved}</div>
          </div>
        </div>
        ...
        <div className="transactions-page__stat-card transactions-page__stat-card--rejected glass-card">
          ...
          <div className="transactions-page__stat-content">
            ...
            <div className="transactions-page__stat-value">{stats.rejected}</div>
          </div>
        </div>
      </div>
      ...
      <div className="transactions-page__filter glass-card">
        <div className="transactions-page__filter-group">
          ...
          <span className="transactions-page__filter-label">Filter by status:</span>
          <select
      ...
      {filteredTransactions.length > 0 ? (
              ...
              <tbody>
                {filteredTransactions.map((transaction, index) => (
                  ...
                  >
                    ...
                    <td>
                      <div className="transactions-page__transaction-id">
                        ...
                        <div className="transactions-page__transaction-id-content">
                          <span className="transactions-page__transaction-id-main">{transaction.id}</span>
                          <span className="transactions-page__transaction-id-code">{transaction.transactionCode}</span>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="transactions-page__customer-cell">
                        ...
                        <div className="transactions-page__customer-info">
                          <div className="transactions-page__customer-name">{transaction.userName}</div>
                          <div className="transactions-page__customer-email">{transaction.userEmail}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="transactions-page__payment-method">
                        ...
                        <div className="transactions-page__payment-info">
                          <span className="transactions-page__payment-type">{transaction.paymentMethod}</span>
                          <span className="transactions-page__payment-provider">{transaction.paymentProvider}</span>
                        </div>
                      </div>
                    </td>
                    ...
                    {/* Status */}
                    <td>
                      <span className={`transactions-page__status-badge transactions-page__status-badge--${transaction.status}`}>
                    ...
                    {/* Actions */}
                    <td>
                      <button className="transactions-page__action-btn" type="button">
                        <Eye size={16} />
                        <span>View</span>
                      </button>
                    </td>
        ...
        <div className="transactions-page__empty glass-card">
          ...
          <h3 className="transactions-page__empty-title">No transactions found</h3>
